<template>
  <footer class="py-4 text-bg-primary small">
    <div class="container">
      <div class="row small">
        ...
        <div class="col-md-3">
          ...
          <address class="small text-secondary">
            ...
            <br />
            Email: nguyennttd01427@gmail.com
          </address>
        </div>
        ...
        <div class="col-md-2">
          ...
          <ul class="list-unstyled">
            ...
            <li>
              <a href="/posts" class="text-decoration-none text-secondary">Bài viết</a>
            </li>
            <li>
              <a href="/create-post" class="text-decoration-none text-secondary">Viết bài</a>
            </li>
            <li>
              <a href="/profile" class="text-decoration-none text-secondary">Trang cá nhân</a>
            </li>
          </ul>
        </div>
        ...
        <div class="col-md-2">
          ...
          <ul class="list-unstyled">
            <li>
              <a href="#" class="text-decoration-none text-secondary">Giới thiệu</a>
            </li>
            <li>
              <a href="#" class="text-decoration-none text-secondary">Liên hệ</a>
            </li>
            <li>
              <a href="#" class="text-decoration-none text-secondary">Điều khoản</a>
            </li>
            <li>
        ...
        <div class="col-md-5">
          <h6>Theo dõi tôi</h6>
          <div>
            <a href="https://www.facebook.com/nguyenpttc2007/?locale=vi_VN" target="blank" class="btn btn-primary btn-sm px-3 rounded-pill d-inline-flex align-items-center mb-2 me-1">
            ...
            <a href="" class="btn btn-info btn-sm px-3 rounded-pill d-inline-flex align-items-center mb-2 me-1">
            ...
            <a href="https://www.youtube.com/@NguyenNT38" target="blank" class="btn btn-danger btn-sm px-3 rounded-pill d-inline-flex align-items-center mb-2">
