      ...
      <div class="row g-4">
                  ...
                  <div class="card-body p-4 d-flex flex-column h-100">
                    <div class="mb-3">
                      <span class="badge bg-primary-subtle text-primary rounded-pill px-3 py-2">
                        <i class="bi bi-bookmark-fill me-1"></i>Công nghệ
                      </span>
                    </div>
                    <h2 class="card-title fw-bold mb-3 lh-base">
                      10 mẹo để trở thành lập trình viên giỏi hơn trong năm 2024
                    </h2>
                    <p class="card-text text-muted mb-4 flex-grow-1">
                      Khám phá những bí quyết và thói quen giúp bạn phát triển kỹ năng lập trình một cách hiệu quả và
                      bền vững...
                    </p>
                      ...
                      <div class="d-flex align-items-center">
                        ...
                        <div>
                          ...
                          <div class="text-muted" style="font-size: 0.8rem">
                            <i class="bi bi-clock me-1"></i>5 giờ trước
                          </div>
                        </div>
                      </div>
                      <a href="#" class="btn btn-primary rounded-pill px-4">
                        Đọc ngay <i class="bi bi-arrow-right ms-1"></i>
                      </a>
                    </div>
                  </div>
                </div>
                ...
                <div class="row g-3 align-items-center">
                  <div class="col-md-7">
                    <div class="position-relative">
                      ...
                      <input
                        type="text"
                        class="form-control form-control-lg border-0 bg-light ps-5 rounded-pill"
                ...
                <div class="col-md-4">
                  <div class="post-thumbnail">
                    <img
                      ...
                      alt="Post"
                    />
                    <div class="reading-time"><i class="bi bi-clock-fill me-1"></i>5 phút đọc</div>
                  </div>
                </div>
                <div class="col-md-8">
                  <div class="card-body p-4">
                    <div class="d-flex align-items-center mb-3">
                      ...
                      <div class="dropdown">
                        ...
                        <ul class="dropdown-menu dropdown-menu-end shadow">
                          <li>
                            <a class="dropdown-item" href="#"><i class="bi bi-bookmark me-2"></i>Lưu bài viết</a>
                          </li>
                          <li>
                            <a class="dropdown-item" href="#"><i class="bi bi-share me-2"></i>Chia sẻ</a>
                          </li>
                          <li><hr class="dropdown-divider" /></li>
                          <li>
                            <a class="dropdown-item text-danger" href="#"><i class="bi bi-flag me-2"></i>Báo cáo</a>
                          </li>
                        </ul>
                      </div>
                    </div>
                    ...
                    <span class="badge bg-success-subtle text-success rounded-pill mb-2">
                      <i class="bi bi-compass me-1"></i>Du lịch
                    </span>

                    <h3 class="card-title h5 fw-bold mb-2 lh-base">
                      <a href="#" class="text-decoration-none text-dark stretched-link">
                        Khám phá vẻ đẹp Đà Lạt mùa hoa dã quỳ nở rộ
                      </a>
                    </h3>

                    <p class="card-text text-muted mb-3" style="font-size: 0.9rem">
                      Những cánh đồng hoa vàng rực rỡ trải dài bất tận, tạo nên khung cảnh như tranh vẽ tại thành phố
                      ngàn hoa...
                    </p>

                    <div class="d-flex align-items-center gap-3 text-muted small">
                      <span><i class="bi bi-heart me-1"></i>234</span>
                      <span><i class="bi bi-chat-dots me-1"></i>45</span>
                ...
                <div class="col-md-4">
                  <div class="post-thumbnail">
                    <img
                      ...
                      alt="Post"
                    />
                    <div class="reading-time"><i class="bi bi-clock-fill me-1"></i>8 phút đọc</div>
                  </div>
                </div>
                <div class="col-md-8">
                  <div class="card-body p-4">
                    <div class="d-flex align-items-center mb-3">
                      ...
                      />
                      <div class="me-auto">
                        <div class="fw-semibold small">Lê Văn C</div>
                        <div class="text-muted" style="font-size: 0.75rem">1 tuần trước</div>
                      </div>
                      <div class="dropdown">
                        <button class="btn btn-sm btn-light rounded-circle" type="button" data-bs-toggle="dropdown">
                          <i class="bi bi-three-dots"></i>
                    ...
                    <span class="badge bg-warning-subtle text-warning rounded-pill mb-2">
                      <i class="bi bi-egg-fried me-1"></i>Ẩm thực
                    </span>

                    <h3 class="card-title h5 fw-bold mb-2 lh-base">
                      <a href="#" class="text-decoration-none text-dark stretched-link">
                        Bí quyết làm món phở bò chuẩn vị Hà Nội tại nhà
                      </a>
                    </h3>

                    <p class="card-text text-muted mb-3" style="font-size: 0.9rem">
                      Hướng dẫn chi tiết từng bước để tạo ra tô phở có nước dùng trong vắt, thơm ngon đúng điệu như các
                      quán phở nổi tiếng...
                    </p>

                    <div class="d-flex align-items-center gap-3 text-muted small">
                      <span><i class="bi bi-heart me-1"></i>567</span>
                      <span><i class="bi bi-chat-dots me-1"></i>89</span>
                ...
                <div class="col-md-4">
                  <div class="post-thumbnail">
                    <img
                      ...
                      alt="Post"
                    />
                    <div class="reading-time"><i class="bi bi-clock-fill me-1"></i>12 phút đọc</div>
                  </div>
                </div>
                <div class="col-md-8">
                  <div class="card-body p-4">
                    <div class="d-flex align-items-center mb-3">
                      ...
                      />
                      <div class="me-auto">
                        <div class="fw-semibold small">Phạm Thị D</div>
                        <div class="text-muted" style="font-size: 0.75rem">3 ngày trước</div>
                      </div>
                      <div class="dropdown">
                        <button class="btn btn-sm btn-light rounded-circle" type="button" data-bs-toggle="dropdown">
                          <i class="bi bi-three-dots"></i>
                    ...
                    <span class="badge bg-info-subtle text-info rounded-pill mb-2">
                      <i class="bi bi-lightbulb me-1"></i>Lifestyle
                    </span>

                    <h3 class="card-title h5 fw-bold mb-2 lh-base">
                      <a href="#" class="text-decoration-none text-dark stretched-link">
                        Cân bằng công việc và cuộc sống: Bí quyết của người thành công
                      </a>
                    </h3>

                    <p class="card-text text-muted mb-3" style="font-size: 0.9rem">
                      Làm thế nào để vừa thành công trong sự nghiệp vừa có thời gian cho bản thân và gia đình? Khám phá
                      những chiến lược hiệu quả...
                    </p>

                    <div class="d-flex align-items-center gap-3 text-muted small">
                      <span><i class="bi bi-heart me-1"></i>892</span>
                      <span><i class="bi bi-chat-dots me-1"></i>156</span>
                      <span><i class="bi bi-eye me-1"></i>5.8k</span>
                    </div>
                  </div>
                </div>
              </div>
                ...
                <div class="col-md-4">
                  <div class="post-thumbnail">
                    <img
                      ...
                      alt="Post"
                    />
                    <div class="reading-time"><i class="bi bi-clock-fill me-1"></i>6 phút đọc</div>
                  </div>
                </div>
                <div class="col-md-8">
                  <div class="card-body p-4">
                    <div class="d-flex align-items-center mb-3">
                      ...
                      />
                      <div class="me-auto">
                        <div class="fw-semibold small">Hoàng Văn E</div>
                        <div class="text-muted" style="font-size: 0.75rem">1 ngày trước</div>
                      </div>
                      <div class="dropdown">
                        <button class="btn btn-sm btn-light rounded-circle" type="button" data-bs-toggle="dropdown">
                          <i class="bi bi-three-dots"></i>
                    ...
                    <span class="badge bg-primary-subtle text-primary rounded-pill mb-2">
                      <i class="bi bi-code-slash me-1"></i>Lập trình
                    </span>

                    <h3 class="card-title h5 fw-bold mb-2 lh-base">
                      <a href="#" class="text-decoration-none text-dark stretched-link">
                        Vue.js vs React: Framework nào phù hợp với dự án của bạn?
                      </a>
                    </h3>

                    <p class="card-text text-muted mb-3" style="font-size: 0.9rem">
                      So sánh chi tiết hai framework phổ biến nhất hiện nay, giúp bạn đưa ra quyết định đúng đắn cho dự
                      án tiếp theo...
                    </p>

                    <div class="d-flex align-items-center gap-3 text-muted small">
                      <span><i class="bi bi-heart me-1"></i>445</span>
                      <span><i class="bi bi-chat-dots me-1"></i>78</span>
        ...
        <div class="col-lg-4">
          ...
          <div class="sticky-sidebar" style="position: sticky; top: 100px">
            ...
            <div
              class="card border-0 shadow-sm rounded-4 mb-4 bg-gradient"
            ...
            >
              <div class="card-body p-4 text-white text-center">
                ...
                <button class="btn btn-light btn-lg w-100 rounded-pill fw-semibold">
                  <i class="bi bi-send me-2"></i>Đăng
                </button>
              </div>
            </div>
          </div>
